...
extern "C"  day_of_the_week_t day_of_the_week_add(day_of_the_week_t day, int offset) {
    return (day_of_the_week_t)((day + offset) % (SUNDAY + 1));
}
...
#endif
  java_release_data = (java_release_data_fn_t)dlsym(RTLD_DEFAULT, "java_release_data");
#else
